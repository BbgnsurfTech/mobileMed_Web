                ...
                <table class="table mt-4 w-100 items-table" width="100%">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th class="text-end">{{ __('messages.invoice.amount') }} (<b>{{ $currencySymbol }}</b>)
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($bill['charges'] as $charge)
                            <tr>
                                ...
                                <td class="text-end">{{ number_format($charge->applied_charge) }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                    <tfoot>
                ...
                <table class="table w-100 items-table mb-20" width="100%">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th scope="col" class="text-end">{{ __('messages.ipd_bill.paid_amount') }}
                                (<b>{{ $currencySymbol }}</b>)
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($bill['payments'] as $payment)
                            <tr>
                                ...
                                <td class="text-right">
                                    <p class="text-end">{{ number_format($payment->amount) }}</p>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        <tr>
            <td colspan="2">
                <table class="table number-align">
                    ...
                    <tbody>
                        <tr>
                            <td class="text-start">{{ __('messages.ipd_bill.paid_amount') . ':' }}</td>
                            <td class="font-weight-bold text-end">{{ $bill['total_payment'] }}</td>
                        </tr>
                        <tr>
                            <td class="text-start">{{ __('Bed Charge') . ':' }}</td>
                            <td class="font-weight-bold text-end"><b>{{ getCurrencySymbol() }}</b>{{ $bill['bedCharge'] }}</td>
                        </tr>
                        <tr>
                            <td class="text-start">{{ __('messages.ipd_bill.total_charges') . ':' }}</td>
                            <td class="text-right font-weight-bold">{{ $bill['total_charges'] }}</td>
                        </tr>
                        <tr>
                            <td class="text-start">{{ __('messages.ipd_bill.gross_total') . ':' }}</td>
                            <td class="text-right font-weight-bold">
                                {{ $bill['gross_total'] > 0 ? $bill['gross_total'] : 0 }}</td>
                        </tr>
                        <tr>
                            <td class="text-start">{{ __('messages.ipd_bill.discount_in_percentage') . ':' }}</td>
                            <td class="text-right font-weight-bold">{{ $bill['discount_in_percentage'] . '%' }}</td>
                        </tr>
                        <tr>
                            <td class="text-start">{{ __('messages.ipd_bill.tax_in_percentage') . ':' }}</td>
                            <td class="text-right font-weight-bold">{{ $bill['tax_in_percentage'] . '%' }}</td>
                        </tr>
                        <tr>
                            <td class="text-start">{{ __('messages.ipd_bill.other_charges') . ':' }}</td>
                        ...
                        <tr>
                            ...
                            <td class="text-right font-weight-bold">
                                <b>{{ getCurrencySymbol() }}</b>{{ $bill['net_payable_amount'] }}
                            </td>
                        </tr>
                    </tbody>
                </table>
