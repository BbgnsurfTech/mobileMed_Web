        ...
        <div class="d-flex flex-column">
            <div class="card">
                @php
                    ...
                    $planText = $cpData['isExpired'] ? __('messages.new_change.current_expired_plan') : __('messages.new_change.current_plan');
                ...
                <div class="card-body p-lg-10">
                    ...
                    if (!empty(getSuperAdminSettingKeyValue('stripe_enable')) && getSuperAdminSettingKeyValue('stripe_enable') == 1) {
                        $paymentTypes[1] = __('messages.setting.stripe');
                    }
                    if (!empty(getSuperAdminSettingKeyValue('paypal_enable')) && getSuperAdminSettingKeyValue('paypal_enable') == 1) {
                        $paymentTypes[2] = __('messages.setting.paypal');
                    }
                    if (!empty(getSuperAdminSettingKeyValue('razorpay_enable')) && getSuperAdminSettingKeyValue('razorpay_enable') == 1) {
                        $paymentTypes[3] = __('messages.setting.razorpay');
                    }
                    $paymentTypes[4] = __('messages.transaction_filter.manual');
                    $paymentTypes[5] = __('messages.paytm');
                    $paymentTypes[6] = __('messages.setting.paystack');
                    ...
                    @else
                        <div class="row justify-content-center">
                            <div
                                class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 d-flex justify-content-center align-items-center mt-5 plan-controls">
                                <div class="mt-5 me-3 w-50 {{ $newPlan['amountToPay'] <= 0 ? 'd-none' : '' }}">
                                    {{ Form::select('payment_type', $paymentTypes, null, ['class' => 'form-select', 'required', 'id' => 'paymentType', 'data-control' => 'select2', 'placeholder' => __('messages.new_change.select_payment_gateway')]) }}
                                </div>
                                <div
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9">
                                                    <label for="exampleInputImage"
                                                        ...
                                                        :-</label>
                                                    {{ Form::textarea('notes', null, ['class' => 'form-control notes', 'placeholder' => 'Add Your Notes', 'rows' => '5']) }}
                                                </div>
                                            </div>
