...
@role('Admin')
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('users*','accountants*','lab-technicians*','nurses*','pharmacists*','receptionists*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('accounts*','employee-payrolls*','invoices*','payments*','payment-reports*','advanced-payments*','bills*','manual-billing-payments*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('accounts*','employee-payrolls*','invoices*','payments*','payment-reports*','advanced-payments*','bills*','manual-billing-payments*')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('manual-billing-payments*') ? 'active' : '' }}"
       href="{{ route('manual.billing.payment') }}">{{ __('Manual Billing Payments') }}</a>
</li>
@endmodule
@endrole
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('bed-types*','beds*','bed-assigns*','bulk-beds','bed-status')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('bed-assigns*','bed-status') ? 'active' : '' }}"
       href="{{ route('bed-assigns.index') }}">{{ __('messages.bed_assigns') }}</a>
</li>
@endmodule
@endrole
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('patients*','patient-cases*','case-handlers*','patient-admissions*','patient-smart-card-templates*','generate-patient-smart-cards*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('doctors*','doctor-departments*','schedules*', 'holidays*', 'breaks*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('doctors*','doctor-departments*','schedules*', 'holidays*', 'breaks*')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('doctor-departments*') ? 'active' : '' }}"
       href="{{ route('doctor-departments.index') }}"><span class="menu-title" {{$style}}"{{$background}}
        nowrap">{{ __('messages.doctor_departments') }}</span></a>
</li>
@endmodule
@endrole
@role('Admin')
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('accountants*','users*','lab-technicians*','nurses*','pharmacists*','receptionists*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('nurses*','users*','accountants*','lab-technicians*','pharmacists*','receptionists*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('receptionists*','users*','accountants*','lab-technicians*','nurses*','pharmacists*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('lab-technicians*','users*','accountants*','nurses*','pharmacists*','receptionists*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('pharmacists*','users*','accountants*','lab-technicians*','nurses*','receptionists*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('appointments*','appointment-calendars')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('appointments*','appointment-calendars') ? 'active' : '' }}"
       href="{{ route('appointments.index') }}">{{ __('messages.appointments') }}</a>
</li>
@endmodule
@role('Patient')

<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('patient-smart-cards*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('categories*','brands*','medicines*','medicine-purchase*','medicine-bills*','used-medicine*',
'used-medicine*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('pathology-categories*','pathology-tests*','pathology-units*','pathology-parameters*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('diagnosis-categories*','patient-diagnosis-test*','patient-diagnosis-report*')) ? 'd-none' : '' }}">
...
@php($sectionName = (Request::get('section') === null && !Request::is('currency-settings*','hospital-schedules','payment-gateway*')) ?  'general' : Request::get('section'))

<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (Request::is('currency-settings*','settings*','payment-gateway*','hospital-schedules')) ? '' : 'd-none' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('employee/doctor*','doctors*', 'holidays*', 'breaks*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('patients*','patient-admissions*')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('patients*') ? 'active' : '' }}"
       href="{{ route('patients.index') }}">{{ __('messages.patients') }}</a>
</li>
@endmodule
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/dashboard*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/hospital-type*')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('super-admin/hospital-type*') ? 'active' : ''  }}"
       href="{{ route('super.admin.hospitals.index') }}">{{ __('messages.hospitals_type') }}</a>
</li>
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/admins*')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('super-admin/admins*') ? 'active' : ''  }}"
       href="{{ route('admins.index') }}">{{ __('messages.admins') }}</a>
</li>
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/hospitals*','super-admin/hospital/*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/subscription-plans*', 'super-admin/transactions*', 'super-admin/subscriptions-hospitals*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/section-one*','super-admin/section-two*','super-admin/section-three*','super-admin/section-four*','super-admin/section-five*','super-admin/about-us*','super-admin/service-slider*','super-admin/faqs*','super-admin/admin-testimonial*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/general-settings*','super-admin/footer-settings*','super-admin/super-admin-currency-settings*','super-admin/payment-gateway*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/general-settings*','super-admin/super-admin-currency-settings*','super-admin/footer-settings*','super-admin/payment-gateway*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/subscriber*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/enquiries*')) ? 'd-none' : '' }}">
