...
<body>
    <table width="100%" class="mb-20">
                    ...
                    <table class="table w-100 items-table" width="100%">
                        ...
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th class="text-end">{{ __('messages.ipd_patient_diagnosis.description') }}
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($diagnosis as $diagnosis)
                                <tr>
                                    ...
                                    <td>{{ $diagnosis->report_date->format('d/m/Y') }}</td>
                    ...
                    <table class="table w-100 items-table mb-20" width="100%">
                        ...
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th scope="col" class="text-end">{{ __('messages.ipd_patient_charges.date') }}
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($instructions as $instruction)
                                <tr>
                                    ...
                                    <td>{{ $instruction->applied_date->format('d/m/Y') }}</td>
                                    <td class="text-right">
                                        <p class="text-end">{{ $instruction->instruction_date->format('d/m/Y') }}</p>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        @if ($ipdPrescriptions->count() > 0)
            <tr>
                <td colspan="2">
                    <div style="font-size: 18px;font-weight:bold;padding-top:10px;">{{ __('messages.ipd_consultant_register') }}</div>
                    <table class="table w-100 items-table mb-20" width="100%">
                        <thead class="table-dark">
                            <tr>
