<div class="row">
    ...
    <div class="col-sm-6">
        <div class="mb-5">
            ...
            {{ Form::text('assign_date', null, ['class' => (getLoggedInUser()->thememode ? 'bg-light form-control' : 'bg-white form-control'),'id' => isset($bedAssign) ? 'editBedAssignDate' : 'BedAssignDate', 'required']) }}
        </div>
    </div>
    @isset($bedAssign)
        <div class="col-sm-6">
