...
<div class="row gx-10 mb-5">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {{ Form::text('dob', null, ['id'=>'editCaseHandlerBirthDate', 'class' => (getLoggedInUser()->theme_mode) ? 'form-control bg-light' : 'form-control bg-white','autocomplete' => 'off', 'tabindex' => '9']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
