...
<div class="row mb-5">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::text('dob', null, ['class' => (getLoggedInUser()->theme_mode) ? 'form-control bg-light patientBirthDate' : 'form-control bg-white patientBirthDate', 'id' => 'birthDate', 'autocomplete' => 'off', 'tabindex' => '4']) }}
        </div>
    </div>
    <div class="col-md-6">
